...
namespace WYNK.Data.Repository
{
    public interface IAppointmentRepository : IRepositoryBase<AppointmentView>
    {
        ...
        dynamic BookappointmentforpatientsInsideappointment(int CmpID, int Userdoctorid, string date, string panme, string phone, string Address, string time, string gender, int age, string apptreason, string lname, decimal fees);
