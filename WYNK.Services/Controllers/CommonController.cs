...
namespace WYNK.Services.Controllers
{
    ...
    public class CommonController : Controller
    {
        ...
        {
            return _repoWrapper.Common.GetitemsbasedonCMPID(cmpid, format);
        }

        [HttpGet("Getalldropdownvalues/{cmpid}")]
        public dynamic Getalldropdownvalues(int cmpid)
        {
            return _repoWrapper.Common.Getalldropdownvalues(cmpid);
        }
        ...
        [HttpGet("saveparentdesc/{id}/{cmpid}")]
        public dynamic saveparentdesc(string id, int cmpid)
        {
            return _repoWrapper.Common.saveparentdesc(id, cmpid);
        }
